...
export function CodeBoxWordmark() {
  ...
  return (
    <span className="flex items-center gap-0.5" aria-label="CodeBox">
      ...
      <span className="inline-block text-[26px] font-bold leading-none tracking-normal" style={{ fontFamily: "'Arial Narrow', 'Roboto Condensed', Arial, sans-serif", transform: "translateY(3px) scaleX(0.92)", transformOrigin: "left center" }}>
