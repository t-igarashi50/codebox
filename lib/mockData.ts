...
export const seedPosts: CodePost[] = [
  {
    id: "seed-theme-reservation",
    kind: "theme",
    title: "美容室の予約管理をAIで簡単にしたい",
    description: "電話、LINE、Instagram DMから来る予約をまとめて、空き時間の確認まで楽にしたいです。",
    problem: "予約メモがバラバラで、変更やキャンセルがあると見落としが起きます。",
    targetUser: "個人美容室、小さなサロン、ひとり店舗",
    budget: "相談したい",
    reward: "1万円",
    deadline: "2026-07-15",
    themeStatus: "open",
    ...
    aiTool: "Codex",
    xAccount: "@codegarage",
    screenshotUrls: [image("Reservation Idea", "%23ffedd5")],
    createdAt: new Date(Date.now() - 1000 * 60 * 25).toISOString(),
    likes: 57,
    comments: [
      { id: "tc1", body: "これ飲食店でも欲しいです。", createdAt: new Date(Date.now() - 1000 * 60 * 20).toISOString() }
    ],
    code: "コードはまだ貼られていません。"
  },
  {
